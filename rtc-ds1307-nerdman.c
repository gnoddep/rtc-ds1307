/*
 * rtc-ds1307-nerdman.c - RTC driver for some mostly-compatible I2C chips.
 *
 *  Copyright (C) 2005 James Chapman (ds1337 core)
 *  Copyright (C) 2006 David Brownell
 *  Copyright (C) 2009 Matthias Fuchs (rx8025 support)
 *  Copyright (C) 2012 Bertrand Achard (nvram access fixes)
 *  Copyright (C) 2016 Peter Gnodde (SQWE support for ds1307)
 *
...
MODULE_DESCRIPTION("RTC driver for DS1307 and similar chips (nerdman)");
MODULE_LICENSE("GPL");
